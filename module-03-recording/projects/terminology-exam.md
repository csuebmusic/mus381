...
- **When:** Wed Wk 9, second part of the session, after the sample libraries are submitted and verified (Part 1 of that session).
- **Format:** Individual, in class, closed-book, no devices. About 30 minutes.
...
Closed book. No devices. About 30 minutes. 50 points total.
