...
Internal build-time conventions for this repo: chrome, naming, dates, the visual system, and asset recipes.
...
- [`chrome-conventions.md`](./chrome-conventions.md) — document chrome: header / footer roles, title-block tags, lecture / project / handout numbering, separators, subtitles, intro paragraphs, the Today's gear callout
...
- Drafting a reading or handout → `chrome-conventions.md`, `visual-conventions.md`, plus the matching template in `templates/`
...
Most conventions in this folder apply only to **student-facing material** (the HTML in `module-XX-name/lessons/`, `listening/`, and `projects/`). Each convention file flags its scope at the top.
